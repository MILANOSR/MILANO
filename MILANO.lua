...
local UserName = (data.username_ or "NNUNN2")
...
usertext = '*\n ⌯︙العضو »* ['..result.title_..'](t.me/'..(username or 'NNUNN2')..')'
status  = '\n *⌯︙تم ترقيته مطور*'
...
usertext = '\n *⌯︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'NNUNN2')..')'
status  = '\n*⌯︙تم ترقيته مطور*'
...
if MILANO1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌯︙العضو »* ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'NNUNN2')..') \n ⌯︙'..MILANO1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ 𝘀ᴏᴜʀᴄʀ 𝗺𝗶𝗹𝗮𝗻𝗼\n\n[✫  𝗺𝗶𝗹𝗮𝗻𝗼 ᴄʜᴀɴɴᴇʟ](http://t.me/TRR8T)\n\n[✫  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/MiLaNoTam)\n\n[✫  𝗺𝗶𝗹𝗮𝗻𝗼 ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/NNLNNN)\n\n[✫  ʙᴏᴛ ᴍɪʟᴀɴᴏ](http://t.me/SiTmelanobot)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✫ 𝘀ᴏᴜʀᴄʀ 𝗺𝗶𝗹𝗮𝗻𝗼',url="t.me/TRR8T/80"}},
}
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' *⌯︙بواسطه »* ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'NNUNN2')..') \n*⌯︙تـم قفـل الدردشه* ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌯︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'NNUNN2')..') \n*⌯︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
keyboard = {} 
keyboard.inline_keyboard = {{{text=''..dp.first_name_..'',url="t.me/"..dp.username_ or NNUNN2}}}
local msg_id = msg.id_/2097152/0.5
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *⌯︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'NNUNN2')..')'
status  = '\n*⌯︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *⌯︙العضو »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⌯︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'NNUNN2')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *⌯︙العضو »* ['..result.title_..'](t.me/'..(text1[3] or 'NNUNN2')..')'..'\n*⌯︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'NNUNN2')..')'
local iduser = result.sender_user_id_
