...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/MILANOTEAM/Files_MILANO/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevMILANOW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevMILANOW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevMILANOW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevMILANOW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevMILANOW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevMILANOW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevMILANOW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
var = true  
elseif tonumber(user_id) == tonumber(66) then
var = true  
...
local UserName = (data.username_ or "MliNTM")
...
local MILANO_Msg = ''  
if msgs < 100 then 
MILANO_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
MILANO_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
MILANO_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
MILANO_Msg = 'متفاعل' 
elseif msgs < 1200 then 
MILANO_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
MILANO_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
MILANO_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
MILANO_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
MILANO_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
MILANO_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
MILANO_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
MILANO_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
MILANO_Msg = 'رب التفاعل'  
end 
return MILANO_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceMILANO(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
if not DevMILANOW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevMILANOW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,MILANO_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ⌯' and DevMILANOW(msg) then  
...
if text == 'تعطيل التواصل ⌯' and DevMILANOW(msg) then  
...
if text == 'تفعيل البوت الخدمي ⌯' and DevMILANOW(msg) then  
...
if text == 'تعطيل البوت الخدمي ⌯' and DevMILANOW(msg) then  
...
if text == 'ضع كليشه ستارت ⌯' and DevMILANOW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *⌯︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ⌯' and DevMILANOW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *⌯︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ⌯' and DevMILANOW(msg) then 
...
if text == 'الاحصائيات ⌯' and DevMILANOW(msg) then 
...
if text == 'المشتركين ⌯' and DevMILANOW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ⌯' and DevMILANOW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ⌯") and DevMILANOW(msg) then
...
if text == ("قائمه العام ⌯") and DevMILANOW(msg) then
...
if text == ("قائمه الكتم العام ⌯") and DevMILANOW(msg) then
...
if text=="اذاعه خاص ⌯" and msg.reply_to_message_id_ == 0 and DevMILANOW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ⌯" and msg.reply_to_message_id_ == 0 and DevMILANOW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ⌯" and msg.reply_to_message_id_ == 0 and DevMILANOW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ⌯" and msg.reply_to_message_id_ == 0  and DevMILANOW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ⌯" and msg.reply_to_message_id_ == 0  and DevMILANOW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌯︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ⌯' and DevMILANOW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ⌯" and DevMILANOW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ⌯" and DevMILANOW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'*⌯︙عدد الكروبات الان » { '..#group..' }'..MILANOk..''..MILANO..'*\n*⌯︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevMILANOW(msg) then
...
usertext = '*\n ⌯︙العضو »* ['..result.title_..'](t.me/'..(username or 'MliNTM')..')'
status  = '\n *⌯︙تم ترقيته مطور*'
...
if text and text:match("^رفع مطور (%d+)$") and DevMILANOW(msg) then
...
usertext = '\n *⌯︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'MliNTM')..')'
status  = '\n*⌯︙تم ترقيته مطور*'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevMILANOW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevMILANOW(msg) then
...
local MILANO1_Msg = database:get(bot_id.."MILANO1:Add:Filter:Rp2"..text..msg.chat_id_)   
if MILANO1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌯︙العضو »* ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'MliNTM')..') \n ⌯︙'..MILANO1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if MILANO_Msg and not Special(msg) then  
local MILANO_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if MILANO_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *⌯︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌯︙["..MILANO_Msg.."] \n")
else
send(msg.chat_id_,0," *⌯︙العضو :* {["..data.first_name_.."](T.ME/MliNTM)}\n⌯︙["..MILANO_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *⌯︙عذرا »* {["..data.first_name_.."](T.ME/MliNTM)}\n*⌯︙عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})   
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevMILANOW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevMILANOW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevMILANOW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevMILANOW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ⌯" and DevMILANOW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *⌯︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ⌯$") and DevMILANOW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ⌯" and DevMILANOW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ⌯" and DevMILANOW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *⌯︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ⌯" and DevMILANOW(msg) then  
...
database:sadd(bot_id.."MILANO:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."MILANO:blocname"..msg.chat_id_)
...
if name_MILANO then 
names_MILANO = database:smembers(bot_id.."MILANO:blocname"..msg.chat_id_) or ""
if names_MILANO and names_MILANO[1] then 
for i=1,#names_MILANO do 
if name_MILANO:match("(.*)("..names_MILANO[i]..")(.*)") then 
...
database:set(bot_id.."MILANO:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."MILANO:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."MILANO:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."MILANO:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."MILANO:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_MILANOa_new(MILANO1,MILANO2)
if MILANO2 and MILANO2.first_name_ then 
if MILANO2.first_name_:match("(.*)"..database:get(bot_id.."MILANO:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."MILANO:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local MILANO_nnn = database:get(bot_id.."MILANO:nump"..msg.chat_id_) or 5
local MILANO_nnn2 = database:get(bot_id.."MILANO:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(MILANO_nnn2) == tonumber(MILANO_nnn) or tonumber(MILANO_nnn2) > tonumber(MILANO_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."MILANO:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⌯︙عزيزي >>["..MILANO2.username_.."](https://t.me/"..(MILANO2.username_ or "MliNTM")..")\n⌯︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."MILANO:teh"..msg.chat_id_).."} بجانب اسمك\n⌯︙عدد المحاولات المتبقيه {"..(tonumber(MILANO_nnn) - tonumber(MILANO_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_MILANOa_new)
end
end
...
local MILANOChengName = database:get(bot_id.."MILANO:Cheng:Name"..data.id_)
if not data.first_name_ then 
if MILANOChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..MILANOChengName..']')
database:del(bot_id.."MILANO:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if MILANOChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."MILANO:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local MILANOChengUserName = database:get(bot_id.."MILANO:Cheng:UserName"..data.id_)
if not data.username_ then 
if MILANOChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..MILANOChengUserName..']')
database:del(bot_id.."MILANO:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if MILANOChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."MILANO:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local MILANOChengPhoto = database:get(bot_id.."MILANO:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if MILANOChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."MILANO:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if MILANOChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."MILANO:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
⌔︙*𝘸𝘦𝘭𝘤𝘰𝘮𝘦 𝘵𝘰 𝘴𝘰𝘶𝘳𝘤𝘦 𝘔𝘐𝘓𝘈𝘕𝘖*
    ┈┈┈┈┈┈┈┈┈┈┈┈┈┈
⌔︙[𝘮𝘪𝘭𝘢𝘯𝘰 𝘵𝘦𝘢𝘮](https://t.me/MliNTM)
    ┈┈┈┈┈┈┈┈┈┈┈┈┈┈
⌔︙[𝘪𝘯𝘧𝘰𝘳𝘮𝘢𝘵𝘪𝘰𝘯 𝘮𝘪𝘭𝘢𝘯𝘰](https://t.me/TKSLX)
    ┈┈┈┈┈┈┈┈┈┈┈┈┈┈
⌔︙[𝘥𝘦𝘷𝘦𝘭𝘰𝘱𝘦𝘳](https://t.me/MMM5_M)
    ┈┈┈┈┈┈┈┈┈┈┈┈┈┈
⌔︙[𝘛𝘸𝘴 𝘮𝘪𝘭𝘢𝘯𝘰](https://t.me/Tus_1bot)
└───────  ───────┘
]]
send(msg.chat_id_, msg.id_,Text)
end
...
if text == 'رفع نسخه الاحتياطيه' and DevMILANOW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' *⌯︙بواسطه »* ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'MliNTM')..') \n*⌯︙تـم قفـل الدردشه* ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌯︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'MliNTM')..') \n*⌯︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
if text == ("مسح قائمه العام") and DevMILANOW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevMILANOW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function start_function(extra, result, success)
if MILANOSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevMILANOW(msg) then
...
if MILANOSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevMILANOW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevMILANOW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevMILANOW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevMILANOW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevMILANOW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevMILANOW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevMILANOW(msg) then
...
if text == 'الملفات' and DevMILANOW(msg) then
t = ' *⌯︙ملفات السورس ميلانو ↓*\n*•━━━━━━ 𝑴𝑰 ━━━━━━━•* \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if DevMILANOW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/MILANOTEAM/Files_MILANO/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n *⌯︙اهلا بك في متجر ملفات ميلانو*\n*⌯︙ملفات السورس ↓*\n*•━━━━━━ 𝑴𝑰 ━━━━━━━•*\n\n"
local TextE = "\n*•━━━━━━ 𝑴𝑰 ━━━━━━━•*\n *⌯︙علامة تعني { ✓ } ملف مفعل*\n *⌯︙علامة تعني { ✘ } ملف معطل*\n *⌯︙قناة سورس ميلانو ↓*\n".." *⌯︙*[اضغط هنا لدخول](t.me/MliNTM) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevMILANOW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/MILANOTEAM/Files_MILANO/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('MILANO.lua')  
else
send(msg.chat_id_, msg.id_," *⌯︙عذرا الملف لايدعم سورس ميلانو* \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevMILANOW(msg) then
...
if text == "مسح الملفات" and DevMILANOW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *⌯︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevMILANOW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevMILANOW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "MliNTM")
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_MILANO, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_MILANO, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *⌯︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'MliNTM')..')'
status  = '\n*⌯︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *⌯︙العضو »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⌯︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'MliNTM')..')'
...
database:set(bot_id.."MILANO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end
if text then   
local tsssst = database:get(bot_id.."MILANO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *⌯︙ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."MILANO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."MILANO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."MILANO1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."MILANO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *⌯︙تم منع الكلمه مع التحذير*")  
database:del(bot_id.."MILANO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."MILANO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."MILANO1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."MILANO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then
send(msg.chat_id_, msg.id_," *⌯︙ارسل الكلمه الان*")  
database:set(bot_id.."MILANO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."MILANO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."MILANO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."MILANO1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."MILANO1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."MILANO1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."MILANO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."MILANO1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."MILANO1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n *⌯︙قائمة المنع* \n*•━━━━━━ 𝑴𝑰 ━━━━━━━•*\n"
for k,v in pairs(list) do  
local MILANO_Msg = database:get(bot_id.."MILANO1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..MILANO_Msg.."}\n"
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevMILANOW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *⌯︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevMILANOW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *⌯︙العضو »* ['..result.title_..'](t.me/'..(text1[3] or 'MliNTM')..')'..'\n*⌯︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevMILANOW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevMILANOW(msg) then  
...
send(msg.chat_id_, msg.id_,'['..MILANO_Msg[math.random(#MILANO_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevMILANOW(msg) then 
...
if MILANOSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevMILANOW(msg) then 
...
if text == ("ردود المطور") and DevMILANOW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ⌯︙قائمة ردود المطور \n*•━━━━━━ 𝑴𝑰 ━━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevMILANOW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevMILANOW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تفعيل المغادره' and DevMILANOW(msg) then   
...
if text == 'تعطيل المغادره' and DevMILANOW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*⌯︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'MILANO')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'MliNTM')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
MILANOdx(msg.chat_id_, msg.id_, ' *⌯︙ايدي المجموعة » ( '..msg.chat_id_..' )*\n*⌯︙عدد الادمنيه » ( '..data.administrator_count_..' )*\n*⌯︙عدد المحظورين » ( '..data.kicked_count_..' )*\n*⌯︙عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevMILANOW(msg) then
...
{{text = '𝑴𝑰𝑳𝑨𝑵𝑶 𝑻𝑬𝑨𝑴.',url="t.me/D9DD7"}},
}
...
MILANO = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(MILANO)
...
--------------------------------------------------------------------------------------------------------------
SourceMILANO(data.message_,data)
...
------------------------------------------------------------------------
local MILANOAbot = database:get(bot_id.."MILANO1:Add:Filter:Rp2"..text..result.chat_id_)   
if MILANOAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *⌯︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌯︙["..MILANOAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local MILANO1_Msg = database:get(bot_id.."MILANO1:Add:Filter:Rp2"..text..result.chat_id_)   
if MILANO1_Msg then
send(msg.chat_id_, msg.id_," ⌯︙"..MILANO1_Msg)
