...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/MILANOSR/Files_MILANO/main/File_Bot/commands.lua") 
...
⌔︙[𝘮𝘪𝘭𝘢𝘯𝘰 𝘵𝘦𝘢𝘮](https://t.me/MliNTM)
    ┈┈┈┈┈┈┈┈┈┈┈┈┈┈
⌔︙[𝘪𝘯𝘧𝘰𝘳𝘮𝘢𝘵𝘪𝘰𝘯 𝘮𝘪𝘭𝘢𝘯𝘰](https://t.me/D9DD7)
    ┈┈┈┈┈┈┈┈┈┈┈┈┈┈
...
if DevMILANOW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/MILANOSR/Files_MILANO/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/MILANOSR/Files_MILANO/main/File_Bot/"..file)
if res == 200 then
